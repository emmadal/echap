...
export const posts: Array<IPost> = [
  ...
  {
    id: '2',
    title: 'SHORT SLEEVE CHECKERED TOP',
    price: 980000,
    authorId: '1',
    banner:
  ...
  },
  {
    ...
    authorId: '1',
    banner:
      'https://media.cnn.com/api/v1/images/stellar/prod/edit-img-8629.jpg?c=16x9&q=h_653,w_1160,c_fill/f_webp',
    categoryId: '1',
    description:
      'The iMac is an "all-in-one," which houses the computer, drives and monitor in the same case. Apple also makes two computers with separate monitors: a mini desktop and workstation (see Mac mini and Mac Pro)',
    phone: '+2250707070707',
  ...
  },
  {
    ...
    authorId: '1',
    banner:
      'https://i.pinimg.com/736x/2f/69/16/2f69169f2cacdd08ccf399143d3c59a3.jpg',
    categoryId: '6',
    description:
      'The iMac is an "all-in-one," which houses the computer, drives and monitor in the same case. Apple also makes two computers with separate monitors: a mini desktop and workstation (see Mac mini and Mac Pro)',
    phone: '+2250707070707',
